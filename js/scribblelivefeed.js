...
function ScribbleLiveFeed(Options) {
  ...
  this.InstanceIndex = ScribbleLiveFeed.storeInstance(this);
...
// Set the index.
ScribbleLiveFeed.Index = 0;

// The function that decides which instance of the recent posts object is currently being used.
ScribbleLiveFeed.getInstance = function (pIndex) {
  if (ScribbleLiveFeed.__instances === undefined) {
    return undefined;
  } else {
    return ScribbleLiveFeed.__instances['' + pIndex];
  }
};

// The function that sets the instance of the recent posts object.
ScribbleLiveFeed.storeInstance = function (pScribbleLiveFeedInstance) {
  if (ScribbleLiveFeed.__instances === undefined) {
    ScribbleLiveFeed.__instances = [];
  }

  var _Index = ScribbleLiveFeed.Index;
  ScribbleLiveFeed.Index++;

  ScribbleLiveFeed.__instances[_Index] = pScribbleLiveFeedInstance;
...
ScribbleLiveFeed.prototype.drawPosts = function (pResponse, type) {
  ...
  if (type === 'RECENT') {
    ...
    var wait = setTimeout("ScribbleLiveFeed.getInstance(" + this.InstanceIndex + ").GetNewPosts()", this.Options.PoolingTime);
...
ScribbleLiveFeed.prototype.createPostList = function () {
  ...
  widgetDiv.setAttribute("id", this.Options.WidgetClass + this.InstanceIndex);
...
ScribbleLiveFeed.prototype.getPostList = function () {
  ...
  var CurrentPosts = document.getElementById(this.Options.WidgetClass + this.InstanceIndex).getElementsByTagName("li");
...
ScribbleLiveFeed.prototype.getAllPosts = function () {
  ...
  this.requestAPI('GET', requestUrl, ScribbleLiveFeed.getInstance(this.InstanceIndex).DrawNewPosts.bind(this));
};
...
ScribbleLiveFeed.prototype.GetNewPosts = function () {
  ...
  console.log('[SCRIBBLE] Pooling - Loading new posts ...');
  this.requestAPI('GET', requestUrl, ScribbleLiveFeed.getInstance(this.InstanceIndex).DrawNewPosts.bind(this));
};
...
ScribbleLiveFeed.prototype.getOlderPosts = function () {
  ...
  this.requestAPI('GET', requestUrl, ScribbleLiveFeed.getInstance(this.InstanceIndex).DrawOlderPosts.bind(this));
};
...
ScribbleLiveFeed.prototype.loadExternalScripts = function () {
  ...
  this.loadStyles(this.Options.Theme);
...
// Load styles
ScribbleLiveFeed.prototype.loadStyles = function (theme) {
